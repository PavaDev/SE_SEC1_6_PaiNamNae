                ...
                <div v-else-if="report" class="bg-white border border-gray-300 rounded-lg shadow-sm p-6 mb-6">
                    ...
                    <div class="py-6 border-b border-gray-200">
                        ...
                        <div class="flex items-center gap-4">
                            <img :src="report.reporterAvatar"
                                class="object-cover rounded-full w-12 h-12" alt="avatar" />
                            <div>
                                <p class="font-medium text-gray-900">{{ report.reporterName }}</p>
                    ...
                    <div class="py-6 border-b border-gray-200">
                        <div class="grid grid-cols-2 gap-6">
                            ...
                            <div v-if="report.targetObjectId">
                                ...
                                <p class="font-medium text-gray-900">{{ report.targetObjectId }}</p>
                            </div>
                        </div>
                    </div>
...
const { getReportById, deleteReport } = useReport()
