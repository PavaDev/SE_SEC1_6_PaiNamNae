        ...
        <nav class="space-y-4">
            <div>
                ...
                <ul class="space-y-1">
                    ...
                    <li>
                        <NuxtLink to="/profile/reviews" class="block px-4 py-2 text-sm rounded-md"
                            :class="isActive('/profile/reviews') ? 'font-semibold text-blue-600 bg-blue-100' : 'text-gray-700 hover:bg-gray-100'">
                            รีวิวของฉัน
                        </NuxtLink>
                    </li>
                </ul>
            ...
            <div>
                <h3 class="text-sm font-semibold text-gray-900 mb-2 px-4">รายงานปัญหา</h3>
                <ul class="space-y-1">
                    <li>
                        <NuxtLink to="/profile/reports" class="block px-4 py-2 text-sm rounded-md"
                            :class="isActive('/profile/reports') ? 'font-semibold text-red-600 bg-red-50' : 'text-gray-700 hover:bg-gray-100'">
                            รายงานและติดตามปัญหา
                        </NuxtLink>
                    </li>
                </ul>
            </div>
