                ...
                >
                    <div class="relative w-full max-w-sm bg-white rounded-[2.5rem] shadow-2xl overflow-hidden">
                        ...
                        <div class="p-8 text-center bg-white">
                            ...
                            <div v-if="passengerArrivalData.reason && passengerArrivalData.reason.trim()" class="mb-8 p-4 bg-gray-50 rounded-2xl border border-gray-100 flex items-start gap-3 text-left">
